...
class HamburguesaIngredientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hamburguesa_ingrediente" do
    assert_difference('HamburguesaIngrediente.count') do
      post hamburguesa_ingredientes_url, params: { hamburguesa_ingrediente: { hamburguesa_id: @hamburguesa_ingrediente.hamburguesa_id, ingrediente_id: @hamburguesa_ingrediente.ingrediente_id } }, as: :json
    end
  ...
  test "should update hamburguesa_ingrediente" do
    patch hamburguesa_ingrediente_url(@hamburguesa_ingrediente), params: { hamburguesa_ingrediente: { hamburguesa_id: @hamburguesa_ingrediente.hamburguesa_id, ingrediente_id: @hamburguesa_ingrediente.ingrediente_id } }, as: :json
    assert_response 200
  end
